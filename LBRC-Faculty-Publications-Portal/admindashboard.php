...
// Get the logged-in admin ID and admin name
$admin_id = $_SESSION['admin_id'];
$admin_name = $_SESSION['name']; // Make sure this session variable is set during the login

// Query to get all publications for all faculties
...
<div class="container">
    <h2>Welcome, Admin <?php echo $admin_name; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="logout.php"><button>Logout</button></a></h2>    
    
	<a href="faculty_publication_report.php"><button>All Faculty Publication Report</button></a>
	<!--<a href="in_faculty_publication_report.php"><button>Individual Faculty Publication Report</button></a>--><br><br>
    ...
    ?>
	<br>
<caption > List of ALL Faculty Publications </caption>
    <table>
